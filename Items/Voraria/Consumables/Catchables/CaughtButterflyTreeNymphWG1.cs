...
{
	public class CaughtButterflyTreeNymphWG1 : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.placeStyle = (int)NormalButterflyStuff.VanillaButterflySpecies.TreeNymph + (8 * 1) + 1;
		...
		public override void ModifyTooltips(List<TooltipLine> tooltips)
		{
			tooltips.AddVorariaItemTooltip(
				"Voraria.Consumables.Catchables.Butterflies.TreeNymph.WeightGain1",
				new
				{
