...
namespace V2.Items.Vanilla.Consumables.Potions
{
	public class HealingPotionSuper : GlobalItem
	{
		...
		public override bool AppliesToEntity(Item entity, bool lateInstantiation) => entity.type == ItemID.SuperHealingPotion;
		...
		public override void ModifyTooltips(Item item, List<TooltipLine> tooltips)
		{
			tooltips.AddVorariaItemTooltip(
				"Vanilla.Consumables.Potions.Healing.Super",
				new
				{
